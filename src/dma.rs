...
impl Dma {
    ...
    pub fn irq(&self) -> bool {
        let channel_irq = self.channel_irq_flags & self.channel_irq_enable;
        self.force_irq || (self.irq_enable && channel_irq != 0)
    }
...
impl Port {
    pub fn from_index(index: u8) -> Port {
        match index {
            0 => Port::MdecIn,
            1 => Port::MdecOut,
            2 => Port::Gpu,
